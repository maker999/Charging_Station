...
{  
  ...
  if (packet->function == PRESET_MULTIPLE_REGISTERS || packet->function == WRITE_HOLDING_REGISTERS) {
...
void sendPacket(unsigned char bufferSize)
{
  ...
  delayMicroseconds(T3_5); //I added this because I read on wiki
